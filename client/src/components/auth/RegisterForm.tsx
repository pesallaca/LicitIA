    ...
    <div className="min-h-screen bg-[#E4E3E0] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-[#141414] p-8 shadow-[4px_4px_0px_0px_rgba(20,20,20,1)]">
          <h2 className="font-serif text-2xl italic mb-6">Crear Cuenta</h2>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs font-bold uppercase tracking-wider block mb-2">Nombre (opcional)</label>
              <input
                type="text"
                value={name}
          ...
          >
            {loading ? <><Loader2 className="animate-spin" size={18} /> Registrando...</> : 'Crear Cuenta'}
          </button>
